<div class="row">
    <div class="col-md-8">
        ...
        <select name="currency_rate_exchange_service" class="form-control custom-select-black " id="currency_rate_exchange_service" ><option value="">Select Service</option><option value="fixer">Fixer</option><option value="forge">Forge</option><option value="currency_data_feed">Currency Data Feed</option></select>
            </div>
        <div style="display: none">
