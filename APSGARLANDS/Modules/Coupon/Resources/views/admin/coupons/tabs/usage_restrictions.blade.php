<div class="row">
    <div class="col-md-8">
        {{ Form::number('minimum_spend', trans('coupon::attributes.minimum_spend'), $errors, $coupon, ['required' => true]) }}
        {{ Form::number('maximum_spend', trans('coupon::attributes.maximum_spend'), $errors, $coupon, ['required' => true]) }}
