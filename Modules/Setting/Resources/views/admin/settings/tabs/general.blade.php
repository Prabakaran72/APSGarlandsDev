<div class="row">
    <div class="col-md-8">
        ...
        {{ Form::checkbox('recurring_order_enabled', trans('setting::attributes.recurring_order_enabled'), trans('setting::settings.form.allow_recurring_order'), $errors,$settings ) }}
