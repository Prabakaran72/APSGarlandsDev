...
@push('pre-scripts')
    ...
    @if (setting('recurring_order_enabled'))
        <script>
            function show_recurring_details() {
                if (recurring_details_btn.checked == true) {
            ...
            function show_recurring_days() {
                var recurring_frequency = document.getElementById("recurring_frequency");
                var day_options = document.getElementById("day_options");
                var date_options = document.getElementById("date_options");

                if (recurring_frequency.value == "Weekly") { // Weekly
                    day_options.style.display = "block";
                    date_options.style.display = "none";
                } else if (recurring_frequency.value == "Monthly") { // Monthly
                    day_options.style.display = "none";
                    date_options.style.display = "block";
                } else {
                    day_options.style.display = "none";
                    date_options.style.display = "none";
                }
