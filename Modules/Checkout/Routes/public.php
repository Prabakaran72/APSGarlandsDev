...
Route::get('recurring', 'CheckoutCompleteController@recurring_store')->name('checkout.recurring.store');
...
Route::post('checkout/setdeliverydate', 'CheckoutController@setDeliveryDate')->name('checkout.setdeliverydate');
